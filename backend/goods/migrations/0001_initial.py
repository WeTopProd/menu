# Generated by Django 3.2 on 2023-08-31 10:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('hot_dishes', 'Горячие блюда'), ('paste', 'Паста'), ('salads', 'Салаты'), ('side_dishes', 'Гарниры'), ('pizza', 'Пицца'), ('burgers', 'Бургеры'), ('dessert', 'Десерты'), ('drinks', 'Напитки'), ('khachapuri', 'Хачапури'), ('ossetian_pies', 'Осетинские пироги'), ('sauces', 'Соусы'), ('dishes_grill', 'Блюда на мангале'), ('rolls', 'Роллы'), ('mini_rolls', 'Мини роллы'), ('beer_snacks', 'Пивные закуски'), ('bread', 'Хлеб'), ('wok', 'Вок'), ('children_menu', 'Детское меню'), ('seasonal_dishes', 'Сезонные блюда'), ('snacks', 'Закуски'), ('soups', 'Супы')], max_length=50, null=True, verbose_name='Тип блюда')),
