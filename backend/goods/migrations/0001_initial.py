# Generated by Django 3.2 on 2023-09-28 16:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, upload_to='backend_media/', verbose_name='Иконка')),
                ('gif', models.ImageField(blank=True, upload_to='backend_media/', verbose_name='Гифка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(verbose_name='Цена добавки для кальяна')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additive_price', models.IntegerField(blank=True, null=True, verbose_name='Цена добавки для кальяна')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(verbose_name='Цена товара')),
                ('additive_price', models.IntegerField(blank=True, null=True, verbose_name='Цена добавки для кальяна')),
                ('tobacco_type', models.CharField(blank=True, max_length=155, null=True, verbose_name='Тип табака')),
                ('additive_type', models.CharField(blank=True, max_length=155, null=True, verbose_name='Тип добавки для кальяна')),
