...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='goods',
            name='additive_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='goods.hookahadditive', verbose_name='Тип добавки для кальяна'),
        ),
        migrations.AddField(
            model_name='goods',
            name='hookah_type',
        ...
        migrations.AddField(
            model_name='goods',
            name='tobacco_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='goods.hookahtobacco', verbose_name='Тип табака'),
        ),
        migrations.AddField(
            model_name='goods',
            name='type',
